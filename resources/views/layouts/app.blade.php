        ...
        <nav class="nav sub-menu">
            <div class="container">
                <div class="row">
                    ...
                    <a class="nav-link" href="#">FAQ</a> @role('Admin')
                    <a class="nav-link" href="{{ route('users.index') }}">Manage Users</a> @endrole @if (Auth::check())
                    <a class="nav-link" href="{{ route('testrequests.index') }}">Test Requests</a> @endif
                </div>
            </div>
        </nav>
